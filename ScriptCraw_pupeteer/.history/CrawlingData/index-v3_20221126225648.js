...
const website = "https://xoso.com.vn/xsmn-24-11-2022.html";
const pro = async () => {
  ...
  for (let x = 0; x < dai.length; x++) {
    ...
    new Xsmn(dai[x], , tong[0], tong[1], tong[2], tong[3], tong[4], tong[5], tong[6], tong[7], tong[8], tong[9])
    result.push(tong.join("- "));
    // console.log(tong);
    tong.length = 0;
  }
