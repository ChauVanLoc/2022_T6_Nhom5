...
const pro = async () => {
  ...
  const dai = await page.evaluate(() =>
    document.querySelectorAll(
      "#mn_kqngay_24112022_kq > table.table-result.table-xsmn > thead > tr > th:nth-child(2) > h3"
    )
  );
  ...
  //   () =>
  //     document.querySelector(".main .main-content .breadcrumb a").textContent
  // );
  // [...dai].forEach((e) => console.log(e));
  await browser.close();
  return dai[0].textContent;
};
