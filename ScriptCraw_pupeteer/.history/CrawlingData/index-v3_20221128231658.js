...
const pro = async (link) => {
  ...
  for (let x = 0; x < dai.length; x++) {
    ...
    result.push({
      key: convertViToEn(dai[x]) + link.substring(25, 35).replaceAll("-", ""),
      dai: dai[x],
...
const writeDataIntoCSV = (pathData, arr) => {
  const csvWriter = createCsvWriter({
    ...
    header: [
      ...
      { id: "ngay", title: "Date" },
      { id: "giai8", title: "Prize 8" },
      { id: "giai7", title: "Prize 7" },
      { id: "giai6", title: "Prize 6" },
      { id: "giai5", title: "Prize 5" },
      { id: "giai4", title: "Prize 4" },
      { id: "giai3", title: "Prize 3" },
      { id: "giai2", title: "Prize 2" },
      { id: "giai1", title: "Prize 1" },
      { id: "giaiDB", title: "Prize DB" },
    ],
    encoding: "utf-8",
  });
