...
const pro = async () => {
  ...
  await page.goto("https://xoso.com.vn/xsmn-thu-6.html", {
  ...
  const dai = await page.evaluate(() => {
    return [
      ...document.querySelectorAll(
        // "#mn_kqngay_26112022_kq > table.table-result.table-xsmn > thead > tr > th > h3 > a"
        "#mn_kqngay_25112022_kq > table.table-result.table-xsmn > thead > tr > th > h3 > a"
      ),
    ]
      .map((e) => e.textContent)
      .join(", ");
