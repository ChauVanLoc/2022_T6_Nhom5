...
const pathData = `DataCinema_ChauVanLoc.${time}`;
const pathLog = `Log_DataCinema_ChauVanLoc.${time}`;
const threate = [
...
(async () => {
  ...
  for (o of threate) {
    ...
    writeFile(pathData, JSON.stringify(oneThreate));
  }
  isHasError ? "" : writeFile(pathLog, "Finish get data", "Error");
})();
